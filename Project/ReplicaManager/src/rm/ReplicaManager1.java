            ...
            try {
                ...
                while (true) {
                    ...
                    if (sentence.contains("ASK")) {
                        ...
                        String hash_data = hashToString2(ReplicaManager1.this);
                        ...
                        for (int i = 1; i <= 4; i++) {
                            if (rmAndItStatus[i].split("%")[0].equals(Integer.toString(RMport))) {
                                ...
                                if (rmAndItStatus[i].split("%")[1].equals("Timeout")) {
                                    System.out.println("RM1: Timeout is more than 3, we renew our bank servant");
                                ...
                                if(Wrong_Count > 2){
                                    System.out.println("RM1: Wrong_Count is more than 3, we renew our bank servant");
                                ...
                                if (rm1Status.equals("Running")) {
                                    ...
                                    stringToHash2(sender.result, ReplicaManager1.this);
