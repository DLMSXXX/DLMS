...
public class ReplicaManagerX {
    ...
    public ReplicaManagerX(int bankA_port, int bankB_port, int bankC_port, int rm_port, int[] other_rm_port, int fe_port) {
        //set each bank port
    ...
    public void stringToHash(String s, ReplicaManagerX replicaManager2) {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (sentence.contains("ASK")) {
                        RMSender rmSender = new RMSender(receivePacket.getPort(), hashToString(ReplicaManagerX.this));
                        System.out.println();
                    } else {
                        //***************************
                        ...
                        for (int i = 1; i <= 4; i++) {
                            if (rmAndItStatus[i].split("%")[0].equals(Integer.toString(RMport))) {
                                ...
                                stringToHash(data, ReplicaManagerX.this);
                            }
                        }
                    }
