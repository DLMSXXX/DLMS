 ...
 * @author yucunli
 */
public class BankServant4 implements BankServantInterface {
    ...
    //Initialize
    public BankServant4(String _bankName, HashMap<String, Integer> _port_map, int rm_port, int fe_port) {
    ...
    public BankServant4(String _bankName, HashMap<String, Integer> _port_map, int _target_port, int rm_port, int fe_port) {
        account_HashMap = new HashMap<String, ArrayList<Account>>();
        loan_HashMap = new HashMap<String, Loan>();
